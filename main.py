...
PHRASES = {
    ...
    'crit_fail': {
        ...
        'cha': ["Ты открыл рот — и все захотели его закрыть. Навсегда. Даже боги поморщились.", "Ты попытался пошутить. Тишина была такой громкой, что оглохло эхо.", "Твоя улыбка испугала детей. Стариков. И пару демонов.", "Ты хотел быть милым. Получилось криповым.", "Ты соврал. Даже собака поняла. И ушла. Гордо. Боги в лёгком шоке."],
    ...
    'high': {
        ...
        'gamble': ["Тебе везёт. Потихоньку. Без фанатизма.", "Удача рядом. Дышит в спину. Помогает.", "Монетка упала орлом. Не решкой. Уже неплохо.", "Ты сегодня в плюсе."],
...
async def inline_handler(query: types.InlineQuery):
    ...
    if data['count'] > 1 and data['mod'] != 0:
        ...
        results.append(types.InlineQueryResultArticle(
            id=os.urandom(16).hex(),
            title=f"Бросить {data['formula']} (к каждому)",
            description=f"Прибавить {data['mod']:+2} к результату каждого куба",
